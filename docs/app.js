...
const yDT       = Math.round(relTop(pDTEl)    * sy);const title = String(state.text.title || "").slice(0, TITLE_MAX);
    ...
    // Tamaño (selector mejorado: nombre + dimensiones + precio)
    ...
    function renderSizeList(){
      ...
      EXPORT_SIZES.forEach(sz => {
        ...
        // Layout: [S] [A4 · 21 × 29.7 cm] ........ [$20 MXN]
        btn.innerHTML = `
          <div class="sizeOption__left">
            <div class="sizeOption__key">${sz.title}</div>
            <div class="sizeOption__meta">${sz.sub}</div>
          </div>
          <div class="sizeOption__price">${PRICE_LABEL}</div>
        `;
