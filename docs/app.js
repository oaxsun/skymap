...
const yDT       = Math.round(relTop(pDTEl)    * sy);const title = String(state.text.title || "").slice(0, TITLE_MAX);
    ...
    // Sección de pago: Anterior + Comprar en la misma línea (como el maquetado)
    const payRow = document.createElement("div");
    payRow.className = "formRow";
    payRow.style.display = "flex";
    payRow.style.gap = "10px";
    payRow.style.flexWrap = "wrap";

    const prevBtn = document.createElement("button");
    prevBtn.type = "button";
    prevBtn.className = "btn ghost";
    prevBtn.style.flex = "1 1 160px";
